 ...
 * @author kevin
 */
@WebServlet(name = "IotDevServlet", value = "/IotDevServlet")
public class IotDevServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("list") != null) {
            ...
            if (list != null) {
                ...
                if(request.getSession().getAttribute("staff") != null){
                    request.getRequestDispatcher("/deviceStaff.jsp").forward(request, response);
                } else {
        ...
        else if (request.getParameter("idfind") != null){
            if("".equals(request.getParameter("idfind"))){
                response.sendRedirect("/IotDevServlet?list=true");
            }
            List<IotDev> list = iotService.filterList(Integer.parseInt(request.getParameter("idfind")));
            request.setAttribute("list", list);
            if(request.getSession().getAttribute("staff") != null){
                request.getRequestDispatcher("/deviceStaff.jsp").forward(request, response);
            } else {
